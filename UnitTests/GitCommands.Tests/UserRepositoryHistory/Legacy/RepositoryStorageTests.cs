...
using Repository = GitCommands.UserRepositoryHistory.Legacy.Repository;
using RepositoryStorage = GitCommands.UserRepositoryHistory.Legacy.RepositoryStorage;

namespace GitCommands.Tests.UserRepositoryHistory.Legacy
{
    [TestFixture]
