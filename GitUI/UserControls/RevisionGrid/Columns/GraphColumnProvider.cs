...
namespace GitUI.UserControls.RevisionGrid.Columns
{
    internal sealed class GraphColumnProvider : ColumnProvider
    {
        ...
        private readonly GraphLaneInfoProvider _graphLaneInfoProvider;
            ...
            : base("Graph")
        {
            ...
            _graphLaneInfoProvider = new GraphLaneInfoProvider(_graphModel);
            ...
            bool PaintGraphCell(int rowIndex, Rectangle cellBounds, Graphics graphics)
            {
                ...
                bool DrawItem(Graphics g, ILaneRow row)
                {
                    ...
                    var nodeRect = new Rectangle(
                        g.RenderingOrigin.X + ((LaneWidth - _nodeDimension) / 2) + (row.NodeLane * LaneWidth),
        ...
        {
            toolTip = _graphLaneInfoProvider.GetLaneInfo(e.X - ColumnLeftMargin, e.RowIndex);
            return true;
        }
    }
}