...
namespace GitUI.CommandsDialogs.BrowseDialog.DashboardControl
{
    public partial class Dashboard : GitModuleControl
    {
        ...
        {
            var padding24 = (int)(24 * scaleFactor);
        ...
        {
            var scaleFactor = DpiUtil.ScaleX;
            ...
            try
            {
                ...
                AddLinks(flpnlContribute,
                    panel =>
                    {
                        ...
                        CreateLink(panel, scaleFactor, _develop.Text, Resources.develop.ToBitmap(), GitHubItem_Click);
                        CreateLink(panel, scaleFactor, _donate.Text, Resources.dollar.ToBitmap(), DonateItem_Click);
                        CreateLink(panel, scaleFactor, _translate.Text, Resources.EditItem, TranslateItem_Click);
                        var lastControl = CreateLink(panel, scaleFactor, _issues.Text, Resources.bug, IssuesItem_Click);
                        return lastControl;
                    },
                    (panel, lastControl) =>
                    {
                ...
                AddLinks(flpnlStart,
                    panel =>
                    {
                        CreateLink(panel, scaleFactor, _createRepository.Text, Resources.IconRepoCreate, createItem_Click);
                        CreateLink(panel, scaleFactor, _openRepository.Text, Resources.IconRepoOpen, openItem_Click);
                        var lastControl = CreateLink(panel, scaleFactor, _cloneRepository.Text, Resources.IconCloneRepoGit, cloneItem_Click);

                        foreach (var gitHoster in PluginRegistry.GitHosters)
                        {
                            lastControl = CreateLink(panel, scaleFactor, string.Format(_cloneFork.Text, gitHoster.Description), Resources.IconCloneRepoGithub,
